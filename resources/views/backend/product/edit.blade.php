                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <select required class="form-control selectpicker" data-live-search="true"
                                                data-live-search-style="begins" title="Select unit..." name="unit_id">
    ...
    <script type="text/javascript">
        ...
        $(document).find('.add-color-image').on('click', function() {
            ...
            colors.forEach(function(color) {
                // Find a matching product image for the current color
                var productImage = productImages.find(function(image) {
                    return image.color.name.toLowerCase() === color.toLowerCase();
                });
                ...
                // If a matching product image exists, display it; otherwise, show a placeholder
                var imagePreview;
                if (productImage) {
                    ...
                    imagePreview = $('<img class="img-fluid mt-2" src="#" alt="' + color +
                        ' Image" style="display: none; height: 100px;">');
                }
