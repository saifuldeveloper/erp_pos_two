        ...
        <div id="receipt-data">
            <div class="centered">
                @if ($general_setting->site_logo)
                    <img src="{{ url('logo', $general_setting->site_logo) }}" height="50" width="50"
                        style="margin:10px 0;">
                @endif
            ...
            <table class="table-data">
                <tbody>
                    @php
                    $total_product_tax = 0;
                    $total_product_discount = $lims_product_sale_data->sum('discount');
                   @endphp
                    <tr>
                    ...
                    @foreach ($lims_product_sale_data as $key => $product_sale_data)
                        ...
                        <tr>
                            <td colspan="1">
                                ...
                                {{ number_format((float) ($product_sale_data->net_unit_price / $product_sale_data->qty), $general_setting->decimal, '.', ',') }}
                            ...
                            <td style="text-align:center;vertical-align:bottom">
                                @if ($product_sale_data->discount > 0)
                                    {{ $product_sale_data->discount }}
                                @endif
                            </td>
                    ...
                    @if ($total_product_discount > 0)
                        <tr>
                            <th colspan="2" style="text-align:left">{{ trans('file.Product Discount') }}</th>
                            <th style="text-align:right">{{ $total_product_discount }}</th>
                        </tr>
                    @endif
