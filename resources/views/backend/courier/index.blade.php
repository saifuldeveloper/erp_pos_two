            ...
            <table id="courier-table" class="table" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('file.Clinet ID') }}</th>
                        <th>{{ trans('file.Store ID') }}</th>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        user="menu">
                                        <li><button type="button" data-id="{{ $courier->id }}"
                                                data-name="{{ $courier->name }}"
                                                data-phone_number="{{ $courier->phone_number }}"
                                                data-client_id="{{ $courier->client_id }}"
                                                data-client_secret="{{ $courier->client_secret }}"
                                                data-store_id="{{ $courier->store_id }}"
                                                data-username="{{ $courier->username }}"
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $("#editModal input[name='client_id']").val($(this).data('client_id'));
            $("#editModal input[name='client_secret']").val($(this).data('client_secret'));
            $("#editModal input[name='store_id']").val($(this).data('store_id'));
            $("#editModal input[name='username']").val($(this).data('username'));
            $("#editModal input[name='password']").val($(this).data('password'));
        });
