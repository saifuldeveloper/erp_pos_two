            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">purchase <span class="float-right"> {{number_format((float)$purchase[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">Purchase Return <span class="float-right"> {{number_format((float)$purchase_return[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">Sale <span class="float-right"> {{number_format((float)$sale[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">Sale Return <span class="float-right"> {{number_format((float)$return[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
