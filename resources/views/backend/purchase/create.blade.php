...
@push('scripts')
    <script type="text/javascript">
                    ...
                    if (flag) {
                        datas.forEach(function(data) {
                            ...
                            cols +=
                                ...
                                data[9] + '"/>';
                            cols +=
                                '<input type="hidden" class="purchase-unit" name="purchase_unit[]" value="' +
                                temp_unit_name[0] + '"/>';
                            cols +=
        ...
        function checkQuantity(purchase_qty, flag) {
            ...
            if (flag)
                product_cost[rowindex] = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.original-cost').val() * exchangeRate;
