    ...
    <div class="row">
        <div class="container-fluid">
            <div class="col-md-12">
                ...
                @if (!empty($customer) && !empty($customer->points))
                                            ...
                                            @foreach ($lims_sale_data as $key => $sale)
                                                ...
                                                <tr
                                                    ...
                                                    @elseif($sale->payment_status == 3)
                                                        <td>
                                                            <div class="badge badge-success">{{ trans('file.Partial') }}
                                                            </div>
                                                        </td>
                                                    @else
                                                        <td>
                                                    ...
                                                    <td>{{ number_format($sale->grand_total - $sale->paid_amount, 2) }}
                                                    </td>
                                        ...
                                        <tbody>
                                            @foreach ($lims_quotation_data as $key => $quotation)
                                                ...
                                                <tr class="quotation-link"
                                                    ...
                                                    <td>{{ $key }}</td>
                                                    <td>{{ date($general_setting->date_format, strtotime($quotation->created_at->toDateString())) . ' ' . $quotation->created_at->toTimeString() }}
                                                    </td>
                                                    ...
                                                    <td><button type="button"
                                                            class="btn btn-info btn-sm quotation-view-btn"
                                                            title="{{ trans('file.View') }}"><i
                                                                class="dripicons-preview"></i></button></td>
                                                </tr>
                                            @endforeach
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="container mt-3 pb-2 border-bottom">
                    <div class="row">
                        <div class="col-md-3">
                            <button id="quotation-print-btn" type="button"
                                class="btn btn-default btn-sm d-print-none"><i class="dripicons-print"></i>
