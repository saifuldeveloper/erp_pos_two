                ...
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('file.Sale Reference') }}</th>
                         <th>{{ trans('file.Courier Track ID') }}</th>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        <li><a href="{{ route('delivery.invoice', $delivery->id) }}"
                                                class=" btn btn-link"><i class="dripicons-print"></i>Print</a></li>
                                        <li>
                                            <form method="POST"
                                                action="{{ route('delivery.send.courier', $delivery->id) }}"
                                                style="display:inline;">
                                                @csrf
                                                <button type="submit" class="btn btn-link">
                                                    <i class="fa fa-truck"></i>
                                                    Send To {{ @$delivery->courier->name }}
                                                </button>
                                            </form>
                                        </li>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="courier_id" id="courier_id" class="selectpicker form-control" required
