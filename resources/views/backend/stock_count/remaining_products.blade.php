                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>অবশিষ্ট বাকি প্রোডাক্টস (Warehouse: {{ $lims_stock_count->warehouse->name }}) ({{ $lims_stock_count->id }})</h4>
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => ['stock-count.remaining-products', $lims_stock_count->id], 'method' => 'GET', 'id' => 'filter-form']) !!}
                            <div class="row mb-4 align-items-end">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ route('stock-count.remaining-products', $lims_stock_count->id) }}" class="btn btn-secondary" style="flex: 1;"><i class="fa fa-undo"></i> Reset</a>
                                    </div>
                                </div>
                            </div>
                            {!! Form::close() !!}
                            <div class="table-responsive">
                                <table class="table table-hover" id="remaining-products-table" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $('#remaining-products-table').DataTable({
            "order": [],
            "pageLength": 25,
            "lengthMenu": [
                [10, 25, 50, 100, -1],
